  ...
  totalProductos = [
   ...
   { id: 1, nombre: 'Corona 1', precio: 800, tipo: 'avatar_pendant', esNuevo: true, imagenUrl: 'assets/corona1.png' },
    ...
    { id: 4, nombre: 'Corona 4', precio: 1500, tipo: 'avatar_pendant', esNuevo: true, imagenUrl: 'assets/corona4.png' },
     { id: 4, nombre: 'Corona 5', precio: 1500, tipo: 'avatar_pendant', esNuevo: true, imagenUrl: 'assets/corona5.png' },
      { id: 4, nombre: 'Corona 6', precio: 1500, tipo: 'avatar_pendant', esNuevo: true, imagenUrl: 'assets/corona6.png' },
       { id: 4, nombre: 'Corona 7', precio: 1500, tipo: 'avatar_pendant', esNuevo: true, imagenUrl: 'assets/corona7.png' },
        { id: 4, nombre: 'Corona 8', precio: 1500, tipo: 'avatar_pendant', esNuevo: true, imagenUrl: 'assets/corona8.png' },
         { id: 4, nombre: 'Corona 9', precio: 1500, tipo: 'avatar_pendant', esNuevo: true, imagenUrl: 'assets/corona9.png' },
