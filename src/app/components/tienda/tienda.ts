...
obtenerEscala(id: number): string {
  switch(id) {
    case 4:
      return 'scale(1.25)'; // La agrandamos para que "cierre" más sobre la foto
    case 8:
    case 9:
      return 'scale(0.9)';  // Las achicamos un poco para que no tapen todo
    default:
      return 'scale(1.1)';  // Tamaño estándar
  }
}
